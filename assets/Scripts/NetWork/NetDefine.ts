...
{
    public static HTTP_IP:string='http://47.111.161.209:8082';
    public static HTTP_LEVEL_IP:string='http://192.168.1.110:8080';
...
export enum RequestType {
    ...
    /** 更新邮箱领取状态 */
    email_update='/playerEmail/updateEmail',
    /** 查询新邮件数量 */
    email_new_number='/playerEmail/newEmailNumber',
}
